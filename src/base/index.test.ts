...
describe("index", () => {
    ...
    describe("findInstances()", () => {
        it("is not supported", () => {
            expect(() => testee().findInstances(undefined, undefined)).toThrow(new NotFoundError("Finding instances not supported"))
        })
    })

    describe("addInstance()", () => {
        it("is not supported", () => {
            expect(() => testee().addInstance(undefined, undefined, undefined)).toThrow(new NotFoundError("Creating instances not supported"))
        })
    })

    describe("deleteInstance()", () => {
        it("is not supported", () => {
            expect(() => testee().deleteInstance(undefined, undefined, undefined)).toThrow(new NotFoundError("Deleting instances not supported"))
        })
    })

    describe("getInstanceParameters()", () => {
        it("is not supported", () => {
            expect(() => testee().getInstanceParameters(undefined, undefined)).toThrow(new NotFoundError("Creating instances not supported"))
        })
    })

    describe("readInstanceParameterValues()", () => {
        it("is not supported", () => {
            expect(() => testee().readInstanceParameterValues(undefined, undefined, undefined)).toThrow(new NotFoundError("Reading instance parameter values not supported"))
        })
    })
})
